...
output logic [inst_width-1:0]instruction
    ...
    //jal
    assign Inst_mem[24]  = 32'h00008413;//      jal x11, 24(Decimal)    ALResult = h64       jump to inst[30] 
    //return
    ...
    //JALR
    assign Inst_mem[33]  = 32'h00311733;//     jalr x13, 0(x11)           ALUResult = h88              branch taken to inst_mem[25] 
    ...
    assign Inst_mem[44]  = 32'h00902a23;//     sw 20(r0)<- r9             ALUResult = h14
    assign Inst_mem[45]  = 32'h01402103;//     lw r2<-20(r0)              ALUResult = fffffffe = r2  
    assign Inst_mem[46]  = 32'h01400183;//     lb r3<-20(r0)              ALUResult = fffffffe = r3
    assign Inst_mem[47]  = 32'h01401203;//     lh r4<-20(r0)              ALUResult = fffffffe = r4
    assign Inst_mem[48]  = 32'h01404283;//     lbu r5<-20(r0)             ALUResult = 000000fe = r5
    assign Inst_mem[49]  = 32'h01405303;//     lhu r6<-20(r0)             ALUResult = 0000fffe = r6
    
    
    assign Inst_mem[50]  = 32'h00459693;//     slli r13, r11, 4h          ALUResult = h2f0 = r13
    assign Inst_mem[51]  = 32'h02d00423;//     sb r13->40(r0)             ALUResult = h28  
    assign Inst_mem[52]  = 32'h02802703;//     lw 40(r0) -> r14           ALUResult = fffffff0 = r14
    
    assign Inst_mem[53]  = 32'h02d01423; //    sh r13 ->40(r0)            ALUResult = h28  
    assign Inst_mem[54]  = 32'h02802703;//     lw 40(r0) -> r13           ALUResult = 000002f0  = r13
